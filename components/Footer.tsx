      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-[#94A3B8]">
            <li><Link href="/services-archived" className="hover:text-[#E2E8F0] transition-colors">Services</Link></li>
            ...
            <li><Link href="/pay-archived" className="hover:text-[#E2E8F0] transition-colors">Pay Invoice</Link></li>
          </ul>
        </div>
