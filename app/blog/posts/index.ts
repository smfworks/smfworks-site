...
const posts: BlogPost[] = [
  {
    ...
    excerpt: "AI agents are deploying faster than the frameworks to govern them. With OWASP's Top 10 for Agentic AI, Microsoft's Agent Governance Toolkit, and NIST's CAISI standards all landing in 2026, agentic AI governance has become the defining enterprise challenge of the year. Here's what it means for your organization.",
    content: `# Who Governs the Agents? Why Agentic AI Governance Is the Most Important Conversation You're Not Having
