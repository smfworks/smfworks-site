    ...
    <>
      ...
      <section className="bg-[#001F3F] text-[#E2E8F0] py-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">SMF Blog</h1>
          <p className="text-[#94A3B8] text-lg max-w-2xl leading-relaxed">
            Practical insights on AI, automation, and digital strategy for small businesses.
                      ...
                      <div className="p-6">
                        <div className="flex flex-wrap gap-2 mb-3">
                          {post.categories.map((category) => (
                            <span 
                              key={category}
                              className="text-xs font-semibold text-[#00D4FF] bg-[#00D4FF]/10 px-2 py-1 rounded"
                            >
                              {category}
                            </span>
                          ))}
                        </div>
                        <h2 className="text-xl font-bold mb-3 text-[#E2E8F0] group-hover:text-[#00D4FF] transition-colors">
            ...
            <aside className="lg:w-64 flex-shrink-0">
              <div className="bg-[#131B2E]/60 backdrop-blur-sm rounded-xl border border-[#1e2a45] p-6 sticky top-24">
                ...
                <div className="mt-8 pt-6 border-t border-[#1e2a45]">
                  <h3 className="font-bold text-[#E2E8F0] mb-3 text-sm">Stay Updated</h3>
                  <p className="text-xs text-[#94A3B8] mb-4">
                    Get weekly insights delivered to your inbox.
                  </p>
                  <Link 
                    href="/#newsletter" 
                    className="block w-full bg-[#FF6B00] text-white text-center py-2.5 rounded-lg text-sm font-semibold hover:bg-[#e55f00] transition-colors"
                  >
                    Subscribe
                  </Link>
                </div>
