...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: post.title,
      description: post.excerpt,
      url: `https://smfworks.com/publications/the-edge/${post.slug}`,
      siteName: "SMF Works",
      type: "article",
      ...
      <article className="py-12 px-6 bg-[#0b0b0d]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center gap-2 text-sm text-[#7C6A9E] mb-6">
            <Link href="/publications/the-edge" className="hover:text-[#9333EA] transition-colors">
              The Edge
            </Link>
            <span>/</span>
          ...
          {/* Meta */}
          <div className="flex items-center gap-4 text-sm text-[#A78BDB] mb-8 pb-8 border-b border-[rgba(142,166,191,0.15)]/30">
          ...
          {/* Content */}
          <div className="prose prose-invert prose-purple max-w-none text-[#D4C5E8] leading-relaxed prose-headings:text-[#E2E8F0] prose-a:text-[#9333EA] prose-strong:text-[#E2E8F0] prose-blockquote:border-[#9333EA] prose-blockquote:text-[#A78BDB]">
            {post.content.split("\n").map((line, i) => {
          ...
          <div className="mt-12 p-6 bg-[#101014]/80 rounded-xl border border-[rgba(142,166,191,0.15)]/60">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-bold text-[#E2E8F0]">Aiona Edge</p>
          ...
          <div className="mt-12 flex justify-between items-center pt-8 border-t border-[rgba(142,166,191,0.15)]/30">
            {prevPost ? (
              <Link
                href={`/publications/the-edge/${prevPost.slug}`}
            ...
            {nextPost ? (
              <Link
                href={`/publications/the-edge/${nextPost.slug}`}
                className="text-[#9333EA] hover:underline text-sm"
              >
                {nextPost.title} →
              </Link>
