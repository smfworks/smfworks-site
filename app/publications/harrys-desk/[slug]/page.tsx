...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: post.title,
      description: description,
      url: `https://smfworks.com/publications/harrys-desk/${post.slug}`,
      type: "article",
    ...
    alternates: { canonical: `https://smfworks.com/publications/harrys-desk/${post.slug}` },
  };
}
...
export default async function HarryPostPage({
  ...
  const articleSchema = {
    ...
    author: {
      "@type": "Person",
      name: "Harry Mercury",
      url: "https://smfworks.com/publications/harrys-desk",
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://smfworks.com/publications/harrys-desk/${post.slug}`,
    },
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-[#8ea6bf] text-sm leading-relaxed">
                ...
                <Link
                  href="/publications/harrys-desk/welcome-to-harrys-desk"
