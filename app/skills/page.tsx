...
export const metadata: Metadata = {
  title: "SMF Skills | 28 Free OpenClaw Skills",
  description:
    "28 productivity skills for OpenClaw. File organizers, PDF tools, webcam capture, smf-chat, lead capture, invoicing, booking, and more. All free.",
    ...
    <>
      ...
      <section className="bg-[#001F3F] text-[#E2E8F0] py-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-5">28 Skills for Productivity</h1>
      ...
      <section className="bg-[#0A1628] py-16 px-6 border-t border-[#1e2a45]">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-4 mb-10">
            <span className="inline-flex items-center justify-center w-10 h-10 bg-[#00D4FF] text-[#001F3F] rounded-full font-bold">28</span>
            <h2 className="text-3xl font-bold text-[#E2E8F0]">All Skills</h2>
            <span className="text-[#94A3B8] text-sm ml-auto">Free to use. No subscription required.</span>
          </div>
