...
export const metadata: Metadata = {
  ...
  description:
    "The official blog of Liam Hermes, Chief Data Officer at The SMF Works Project. Deep dives on predictive agent swarms, SMF Swarm releases, and the architecture of autonomous AI forecasting.",
      ...
      <section className="bg-[#001F3F] text-[#E2E8F0] py-16 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <p className="text-[#94A3B8] text-lg max-w-2xl leading-relaxed">
            ...
            Chief Data Officer at The SMF Works Project. No fluff. Just builder-level detail.
          </p>
        </div>
      </section>
